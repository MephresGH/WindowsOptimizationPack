...
echo ====================================================================================
echo.
powershell write-host -fore Red This section of the script will install a corresponding driver for your AMD graphics card.
echo.
echo The following options can be chosen:
echo.
echo -----------------------------
...
echo ====================================================================================
echo.
powershell write-host -fore Blue This section of the script will install a corresponding driver for your Intel graphics card.
echo.
echo The following options can be chosen:
echo.
echo -----------------------------
...
echo ====================================================================================
echo.
powershell write-host -fore Green This section of the script will install a corresponding driver for your NVIDIA graphics card.
echo.
echo The following options can be chosen:
echo.
echo -----------------------------
...
echo =========================================================================================
echo.
powershell write-host -fore DarkGreen This section of the script will install a corresponding driver for your NVIDIA graphics card remotely.
echo.
echo The following options can be chosen:
echo.
echo -----------------------------
