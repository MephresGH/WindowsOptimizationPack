<-------------------------->
MODIFIED README SECTION:
>--------------------------<

Before Running DDU, Do the following:
Hold Shift and click on "Troubleshoot", "Start", "Restart"
Select "Advanced Options", "Startup Settings", "Restart"
Select "Enable-/Boot into Safe Mode"
Run script/application
Modify settings to your liking (optional, not recommended)
